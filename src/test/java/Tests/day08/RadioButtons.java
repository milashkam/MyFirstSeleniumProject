...
//        this is step is common for all test cases
    ...
    public void test1(){
        ...
        // muny beforemethoda gechirdik->> driver.findElement(By.linkText("Radio Buttons")).click();

        WebElement blueButton = driver.findElement(By.id("blue"));
        Assert.assertTrue(blueButton.isSelected() ); // will expected that isSelected is true
       ...
       //..beylede bolya->> boolean isSelected = blueButton.isSelected();
